...
export default function RoomCard({ id, name, location, imageUrl }: RoomCardProps) {
  ...
  return (
    ...
    {/* Mouse Tooltip*/}
    {tooltip && (
        <div className="pointer-events-none absolute z-50 flex items-center gap-2 px-3 py-2 rounded-lg bg-(--pastel-yellow) border-2 border-(--dark-blue)"
        style={{ left: tooltip.x, top: tooltip.y - 45}} >
        <MapPin size={15} className="tex-(--dark-blue)" />
